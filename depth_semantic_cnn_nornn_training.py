...
encoder_model = "/home/ubuntu/chg_workspace/depth_semantic/model/encoder/01/model/simulation_autoencoder_700.ckpt"
last_model = ""
...
training_file_path = "/home/ubuntu/chg_workspace/data/new_map_with_deepth_img/deepth_rgb_seemantics/gazebo_rate_092"
...
def read_threading(filename_img1, filename_img2, filename_state, filename_label, file_seq, data_house):
    ...
    read_img_two_channels(data_img, filename_img1, filename_img2)
...
def read_img_two_channels(data_img, filename_img1, filename_img2):  # filename_img1 & filename_img2 must have the same length
    maxInt = sys.maxsize
    decrement = True
