...
if __name__ == '__main__':
    ...
    data1, data2, label = generate_sin_x_plus_y(data_num, cube_dim, concat_paras["dim2"], rnn_paras["output_len"], 0.2, 0.5, 1.5, 3)
    ...
    with tf.Session() as sess:
        ...
        restorer.restore(sess, "/home/ubuntu/chg_workspace/3dcnn/model/model_cnn_rnn_timestep5/450_cnn_rnn_2.ckpt")
