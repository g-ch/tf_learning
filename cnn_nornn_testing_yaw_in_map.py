...
clouds_filename = \
    "/home/ubuntu/chg_workspace/data/yaw_in_map/test/pcl_data_2018_12_28_11:20:55_chg_normal.csv"
states_filename = \
    "/home/ubuntu/chg_workspace/data/yaw_in_map/test/uav_data_2018_12_28_11:20:55_chg_normal.csv"
labels_filename = \
    "/home/ubuntu/chg_workspace/data/yaw_in_map/test/label_data_2018_12_28_11:20:55_chg_normal.csv"
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for i in range(test_data_num):
            ...
            results = sess.run(result, feed_dict={cube_data: data1_to_feed, line_data_2: data3_to_feed})

            results[0, 1] = results[0, 1] * 2.0 - 1.0

            if i % 10 == 0:
                concat_vector_to_show = sess.run(concat_vector, feed_dict={cube_data: data1_to_feed,
                                         line_data_2: data3_to_feed})
                draw_plots(np.arange(0, fully_paras["input_len"]), np.reshape(concat_vector_to_show, [fully_paras["input_len"]]))
