...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        restorer.restore(sess, "/home/ubuntu/chg_workspace/3dcnn/model/cnn_rnn/01/model_short_rnn_layers_with_swing/simulation_cnn_rnn250.ckpt")
        ...
        for i in range(test_data_num):
            ...
            data2_to_feed = states_input[i, :].reshape([1, input_paras["input2_dim"]])
            ...
            if i % 100 == 0:
                concat_vector_to_show = sess.run(concat_vector, feed_dict={cube_data: data1_to_feed, line_data_1: data2_to_feed,
